...
//    sphereGrid = std::vector<std::vector<double> >( gridLA, gridLO );
    // modified by hejw005
    sphereGrid = std::vector< std::vector<double> >(gridLA, std::vector< double >(gridLO, angelAccuracy) );
...
//    std::vector<std::vector<double> > sphereGridNew( gridLA, gridLO );
    std::vector< std::vector< double > > sphereGridNew( gridLA, std::vector< double >( gridLO, x));
...
void VPDetection::lines2Vps( double thAngle,
